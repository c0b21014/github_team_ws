(function(){
	...
	/* 演習1 ここから */
	function add() {eqlNum.value = parseFloat(midNum[0].value) + parseFloat(midNum[1].value);}
	function sub() {eqlNum.value = parseFloat(midNum[0].value) - parseFloat(midNum[1].value);}
	/* 演習1 ここまで */
